...
function HttpRequest()
    HttpRequest(ccall((:sfHttpRequest_create, libcsfml_network), Ptr{Cvoid}, ()))
end

function destroy(request::HttpRequest)
    ccall((:sfHttpRequest_destroy, libcsfml_network), Cvoid, (Ptr{Cvoid},), request.ptr)
end

function set_field(request::HttpRequest, field::AbstractString, value::AbstractString)
    ccall((:sfHttpRequest_setField, libcsfml_network), Cvoid, (Ptr{Cvoid}, Ptr{Cchar}, Ptr{Cchar},), request.ptr, field, value)
end

function set_method(request::HttpRequest, method::HttpMethod)
    ccall((:sfHttpRequest_setMethod, libcsfml_network), Cvoid, (Ptr{Cvoid}, Int32,), request.ptr, Int32(method))
end

function set_uri(request::HttpRequest, uri::AbstractString)
    ccall((:sfHttpRequest_setUri, libcsfml_network), Cvoid, (Ptr{Cvoid}, Ptr{Cchar},), request.ptr, uri)
end

function set_http_version(request::HttpRequest, major::Integer, minor::Integer)
    ccall((:sfHttpRequest_setHttpVersion, libcsfml_network), Cvoid, (Ptr{Cvoid}, Int32, Int32,), request.ptr, major, minor)
end

function set_body(request::HttpRequest, body::AbstractString)
    ccall((:sfHttpRequest_setBody, libcsfml_network), Cvoid, (Ptr{Cvoid}, Ptr{Cchar},), request.ptr, body)
end
...
function destroy(response::HttpResponse)
    ccall((:sfHttpResponse_destroy, libcsfml_network), Cvoid, (Ptr{Cvoid},), response.ptr)
end

function get_field(response::HttpResponse, field::AbstractString)
    bytestring(ccall((:sfHttpResponse_getField, libcsfml_network), Ptr{Cchar}, (Ptr{Cvoid}, Ptr{Cchar},), response.ptr, field))
end

function get_status(response::HttpResponse)
    HttpStatus(ccall((:sfHttpResponse_getStatus, libcsfml_network), Int32, (Ptr{Cvoid},), response.ptr))
end

function get_major_version(response::HttpResponse)
    ccall((:sfHttpResponse_getMajorVersion, libcsfml_network), UInt32, (Ptr{Cvoid},), response.ptr)
end

function get_minor_version(response::HttpResponse)
    ccall((:sfHttpResponse_getMinorVersion, libcsfml_network), UInt32, (Ptr{Cvoid},), response.ptr)
end

function get_body(response::HttpResponse)
    bytestring(ccall((:sfHttpResponse_getBody, libcsfml_network), Ptr{Cchar}, (Ptr{Cvoid},), response.ptr))
end
...
function Http()
    Http(ccall((:sfHttp_create, libcsfml_network), Ptr{Cvoid}, ()))
end

function destroy(http::Http)
    ccall((:sfHttp_destroy, libcsfml_network), Cvoid, (Ptr{Cvoid},), http.ptr)
end

function set_host(http::Http, host::AbstractString, port::Integer=0)
    ccall((:sfHttp_setHost, libcsfml_network), Cvoid, (Ptr{Cvoid}, Ptr{Cchar}, UInt16), http.ptr, host, port)
end

function send_request(http::Http, request::HttpRequest, timeout::Time=Time(0))
    HttpResponse(ccall((:sfHttp_sendRequest, libcsfml_network), Ptr{Cvoid}, (Ptr{Cvoid}, Ptr{Cvoid}, Time), http.ptr, request.ptr, timeout))
end
