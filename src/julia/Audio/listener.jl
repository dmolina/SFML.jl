...
function set_listener_position(pos::Vector3f)
    ccall((:sfListener_setPosition, libcsfml_audio), Cvoid, (Vector3f,), pos)
end
...
function set_listener_direction(direction::Vector3f)
    ccall((:sfListener_setDirection, libcsfml_audio), Cvoid, (Vector3f,), direction)
end
...
function set_listener_upvector(vect::Vector3f)
    ccall((:sfListener_setUpVector, libcsfml_audio), Cvoid, (Vector3f,), vect)
end
